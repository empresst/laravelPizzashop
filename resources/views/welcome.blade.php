...
{{--    <div class="container-fluid">--}}
    <!--Benefits  -->
                ...
                <div class="ac">
                    <div class="img-cover" style=" width: 100%;height: auto;">
                       <!--  @if(is_file('uploads/products/'.$latest['image_prod']))
                        ...
                        @endif -->
                        <img  src="{{ asset('/uploads/products/pik.jpg') }}" alt="">
                    </div>
                    <p>{{$latest['title']}}</p>
                    <div class="rating">
        ...
        <section class="sections">
            ...
            <div class="ab box">
                ...
                <div class="item item-2">
                    ...
                    @endif -->
                    <img  src="{{ asset('/uploads/products/pp2.jpg') }}" alt="">
                </div>
                <div class="item item-3">
                    ...
                    @endif -->
                    <img  src="{{ asset('/uploads/products/po.jpg') }}" alt="">
                </div>
                <div class="item item-4">
                   <!--  @if(is_file('uploads/categories/'.$categories->toArray()[3]['image_cat'])) -->
                    ...
                    <!-- <img src="{{url($categories->toArray()[3]['image_cat'])}}" alt=""> -->
                    <!-- @endif --> 
                    <img  src="{{ asset('/uploads/products/pp3.jpg') }}" alt="">
                </div>
            </div>
        </section>
        ...
        <section class="sections">
            <div class="h">
                <h1><span>Popular</span> Pizzas</h1>
            </div>
            <div class="ac-center box">
                ...
                <div class="ac">
                    <div class="img-cover">
                        ...
                        @else -->
                            <img src="{{ asset('/uploads/other/pizza.jpg') }}" alt="">
                        <!-- @endif -->
                    </div>
                    <p>{{$product['title']}}</p>
                    <div class="rating">
...
@if(\Illuminate\Support\Facades\Auth::user()->role_as==1)
            <div class="blog-post">
                ...
                <p>
                    <a href="{{route('products.index')}}" class="btn btn-info btn-block">Pizza Management</a>
                </p>
                <p>
